...
// ── Word-level timestamps (generated by npm run tts:landhar-v2) ───────────────
const TIMESTAMPS = loadTimestamps('landhar-v2');
...
// Suppress unused-import warnings for exports used by consumers
void CORMORANT_ITALIC;
...
interface BrandIdentityRevealProps {
  ...
  showTagline?:    boolean;
  taglineFrom?:    number;
  voiceoverWords?: import('../style/landhar-typography').VoiceWord[];
}
...
const BrandIdentityReveal: React.FC<BrandIdentityRevealProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Tagline — Card 7 only — voiceover-synced word highlight */}
      {showTagline && (
        <div
          style={{
            marginTop:           22,
        ...
        <AbsoluteFill>
          ...
          >
            <LiveCopy
              ...
              fontSize={LH_TYPE.STATEMENT_LG.fontSize}
              lineHeight={LH_TYPE.STATEMENT_LG.lineHeight}
              letterSpacing={LH_TYPE.STATEMENT_LG.letterSpacing}
            />
        ...
        <AbsoluteFill>
          ...
          <div style={{ position: 'absolute', bottom: 200, left: 80, right: 80 }}>
            <LiveCopy
              ...
              fontSize={LH_TYPE.PUNCH.fontSize}
              lineHeight={LH_TYPE.PUNCH.lineHeight}
              letterSpacing={LH_TYPE.PUNCH.letterSpacing}
              stagger={4}
            />
          </div>
        </AbsoluteFill>
        ...
        <AbsoluteFill>
          ...
          <div style={{ position: 'absolute', bottom: 240, left: 80, right: 80 }}>
            <LiveCopy
              ...
              fontSize={LH_TYPE.PIVOTAL.fontSize}
              lineHeight={LH_TYPE.PIVOTAL.lineHeight}
              letterSpacing={LH_TYPE.PIVOTAL.letterSpacing}
